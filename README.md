...
This is a data and classification pipeline repository for the [TABMON](https://tabmon-eu.nina.no/) (Transnational Acoustic Biodiversity Monitoring Network). The purpose of this repository is to provide an end-to-end framework from raw field data to inference of essential biodiversity variables (EBVs).
