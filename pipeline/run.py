...
if __name__ == "__main__":
    species_list = load_species_list("AvesEcho/inputs/list_sp_ml.csv")
    species_thresholds = pd.read_csv('AvesEcho/inputs/species_thresholds_AvesEcho_1.csv')
    ...
    state_dict = torch.load('AvesEcho/checkpoints/best_model_passt.pt', map_location=device, weights_only=True)
