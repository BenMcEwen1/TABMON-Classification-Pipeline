...
parser.add_argument('--deployment_id', type=str, default=None, required=False, help='Deployment id.')
parser.add_argument('--device_id', type=str, default=None, required=False, help='Device id.')
